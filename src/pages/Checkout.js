      ...
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          ...
          <form className="bg-white px-5">
            <div className="space-y-12">
              <div className="border-b border-white/10 pb-12">
                <h2 className="text-2xl py-5 font-semibold text-gray-900">
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-2 grid grid-cols-1">
                      <select
                        ...
                        className="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white/5 py-1.5 pr-8 pl-3 text-base text-gray-900 outline-1 -outline-offset-1 outline-white/10 *:bg-gray-800 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6"
                      >
              ...
              <div className="border-b border-white/10 pb-12">
                ...
                <ul role="list" className="divide-y divide-gray-400">
                  {addresses.map((address) => (
                    <li
                      key={address.id}
                      className="flex justify-between gap-x-6 py-5 border-solid border-2 border-gray-200 rounded-md p-4"
                    >
                ...
                <div className="mt-10 space-y-10">
                  <fieldset>
                    ...
                    <p className="mt-1 text-sm/6 text-gray-400">Choose one</p>
        ...
        <div className="lg:col-span-2 mt-12">
          <div className="mx-auto bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
            <h4 className="text-2xl py-5 font-bold tracking-tight text-gray-900">
              Cart
            </h4>
